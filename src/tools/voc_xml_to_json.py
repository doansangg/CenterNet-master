...
class PascalVOC2coco(object):
    ...
    def data_transfer(self):
        for num, json_file in enumerate(self.xml):
            ...
            obj_path = glob.glob(os.path.join(path, 'images_new', '*.png'))
            # print(obj_path)
            with open(json_file, 'r') as fp:
                ...
                for p in fp:
                    ...
                    if 'filename' in p:
                        ...
                        self.path = os.path.join(path, 'images_new', self.file_name.split('.')[0] + '.png')
...
dir = '/media/sang/UBUNTU/MEDICAL_SCORE/kvasir-dataset/VisDrone2019-DET-val/annotations_new'
